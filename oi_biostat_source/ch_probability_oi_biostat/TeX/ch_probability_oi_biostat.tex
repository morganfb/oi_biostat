...
\textit{The health care example is getting tired, so I will go back and add an example from bio, perhaps variability of the sum of two or more lab measurement}
