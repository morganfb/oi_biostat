...
\begin{Example}{Expected health care costs under a health insurance plan}
In most typical health insurance plans in the United States, members of the plan pay annually in 3 categories:  a monthly premium; a deductible amount that the member is responsible for before the insurer begins to cover services; and `out-of-pocket costs' consisting of co-payments at each physician visit and for each prescription. Members also pay for care and supplies that are not covered by insurance.  Picking a new health plan involves estimating costs for the next year based on a person's best guess at the kind and number of services that will be needed.
