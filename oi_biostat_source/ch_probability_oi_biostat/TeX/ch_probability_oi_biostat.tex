...
\end{table}
% can xtable insert comma separators automatically?  If not, I will add them by hand. JV: apparently R can do this, but I did not try it http://stackoverflow.com/questions/1581232/adding-commas-into-number-for-output
