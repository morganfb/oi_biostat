...
text(0.5, 2.07, "Skin Test", cex = 0.8)
text(0.2, 1.89, "Positive skin test (wheal)", pos = 3, cex = 0.7)
text(0.2+0.55, 1.89, "Negative skin test (no wheal)", pos = 3, cex = 0.7)
...
# _____ Labels _____ #
rect(-0.05, 0.39 + 0.47, 0.45, 0.45 + 0.47,
     col = "#FFFFFF",
     border = COL[5])
text(0.20, 0.424 + 0.47,
     "Peanut Avoidance (Control)",
     cex = 0.6,
     col = COL[5])

rect(-0.05, 0.39, 0.45, 0.45,
     col = "#FFFFFF",
     border = COL[5])
text(0.20, 0.424,
