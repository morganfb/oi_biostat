...
\textit{DH: The more I think about it, I am inclined to add material on genomic data. The level is too easy so far. And I think we should add back in the section on survey sampling. We should also add a summary at the end of the chapter to remind students what the goals for the chapter are.}
...
\textit{DH: This is part of the latex default. I think it used to be standard in publishing.}
...
Section~\ref{leapCaseStudy} introduces an important problem in medicine: evaluating the effect of an intervention. \textit{JV: Intervention should be defined, could work in a dependent clause. DH: Agree.} Terms in this section, and indeed much of this chapter, will all be revisited later in more detail.
...
\textit{DH: Agree this is confusing; we should leave out the first col. Also possible I did not subset before making this table; needs checking.}

\textit{JV: Just curious...so 267 for the peanut consumption group includes the one child with a positive skin test?}

\textit{DH: I will check about the one child with + skin test.}

\textit{DH: Edits to here, 01 Sept 2015.}
