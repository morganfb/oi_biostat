...
\begin{description}
	...
	\item[Control.] Researchers select participants for the study from a carefullin a way reduces unnecessary variability by that controls forassign treatments to participants, doing their best to \term{control} for variables that other differences in the groups. For example, all infants enrolled in the LEAP study were required to be between 4 and 11 months of age, with severe eczema and/or allergies to eggs.
