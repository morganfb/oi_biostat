...
Let $\alpha$ = 0.05. The T-statistic is
 \[T = \frac{43.9-35.3}{17.97/\sqrt{100}}= \frac{8.6}{1.797} = 4.79\] With $n\geq 30$, the T-statistic can follow a normal distribution to calculate the p-value in $R$. The p-value is 
\begin{verbatim}
> 2*(1-pnorm(4.79))
[1] 1.667813e-06
\end{verbatim}
...
\begin{eqnarray*}
T = \frac{2.14 - 2}{0.08} = 1.75 \quad\stackrel{\text{table or $R$}}{\rightarrow}\quad \text{left tail}=0.04
\end{eqnarray*}
