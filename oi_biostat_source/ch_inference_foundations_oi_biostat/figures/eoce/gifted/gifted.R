...
par(mar=c(3.7,2,1,1), las=1, mgp=c(2.5,0.7,0), mfrow = c(1,1), cex.lab = 1, cex.axis = 1)
...
axis(1, at = c(m - 3*s,l,m,u,m + 3*s), label = c(NA,l,m,u,NA), cex.axis = 1)
...
histPlot(gifted$motheriq, col = COL[1], xlab = "Mother's IQ", ylab = "", ylim=c(0,14), cex.lab = 0.8)

par(las = 1, mar = c(4, 3, 1.4, 1))
histPlot(gifted$fatheriq, col = COL[1], xlab = "Father's IQ", ylab = "", ylim=c(0,14), cex.lab = 0.8)
